  ...
  return (
    <div className="fdp" >
        ...
        <div className={"text-section-fdp"}>
            ...
            <p>Grâce à notre simulateur, calculez en 2 minutes votre montant d'aides, et estimez gratuitement votre devis afin de savoir si vous pouvez bénéficier du système solaire combiné à 1 €!
